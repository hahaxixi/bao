define("scripts/fruit-manager.js", function(exports, require, module) {
  ...
  var groups = {
    "frog": [
      {img: "f1", width: 96, height: 96, radius: 36, fixAngle: 5},
      {img: "f2", width: 96, height: 96, radius: 36, fixAngle: 5},
      {img: "f3", width: 96, height: 96, radius: 36, fixAngle: -25},
      {img: "f4", width: 96, height: 96, radius: 36, fixAngle: -25},
      {img: "f5", width: 96, height: 96, radius: 36, fixAngle: -45},
      {img: "f6", width: 96, height: 96, radius: 36, fixAngle: -45}
    ],

    "bun": [
      {img: "b1", width: 64, height: 64, radius: 32, fixAngle: -45, color: "#e6c731"},
      {img: "b2", width: 64, height: 64, radius: 32, fixAngle: -85, color: "#e6c731"},
      {img: "b3", width: 64, height: 64, radius: 32, fixAngle: -5, color: "#e6c731"},
      {img: "b4", width: 64, height: 64, radius: 32, fixAngle: -95, color: "#e6c731"}
    ],
